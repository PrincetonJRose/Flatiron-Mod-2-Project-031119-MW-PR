...
Affected By Intersex/ Differences Of Sex Development (DSD).
')

 Resource.create(name:'The Health Initiative', number:'404-688-2524', url:'http://thehealthinitiative.org/', address:'530 DeKalb Avenue', city: 'Atlanta', state:'GA', country:'USA', description:'The Health Initiative is dedicated to improving the health and wellbeing of Georgia’s Lesbian, Gay, Bisexual, Transgender and Queer community through education, support, access to care and advocacy.')
